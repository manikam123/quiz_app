                        ...
                        <Card style={css.quizBox()}>
                            <Card.Body>
                                ...
                                <Row className="text-center mt-3">
                                    ...
                                    <Col md="4">
                                        <ButtonComponent quizId="quizId2" quizName="Arithmetic Quiz 2" answer={this.state.answer} check_answer={QuizFunction.check_answer} clearInterval={timerInterval} setCounter={this.setCounter} updateScore={this.props.updateScroe}  that={this} />
                                    </Col>
                                </Row>
